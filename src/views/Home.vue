    ...
    <div class="relative min-h-[100svh] flex items-center justify-center overflow-hidden py-20 px-4">
      ...
      <div class="relative z-10 text-center">
        ...
        <p class="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 animate-slide-up delay-300 px-4">
          Трагедія українського народу у XX столітті
        </p>
        <router-link 
          to="/timeline" 
      ...
      <div class="mb-12 sm:mb-16 lg:mb-20 animate-fade-in-up">
        ...
        <div class="prose prose-sm sm:prose-base lg:prose-lg prose-invert mx-auto px-4">
          <p class="text-gray-300 mb-6 hover:text-gray-200 transition-colors duration-300">
            Масові репресії стали однією з найстрашніших сторінок історії України у XX столітті. Ці процеси, які набули свого апогею у період правління Йосипа Сталіна, охоплювали широкі верстви населення: від селян і представників інтелігенції до членів партійного апарату. Репресивна політика радянської влади мала далекосяжні наслідки для національної самосвідомості, культурного розвитку та демографічного складу українського народу.
          </p>
        </div>
      </div>
...
const keyPoints = ref([
  {
    title: 'Хронологія',
    description: 'Основні етапи репресій: 1920-1930-і роки, Голодомор 1932-1933, Велика чистка 1937-1938.',
    link: '/timeline'
  },
  {
    title: 'Йосип Сталін',
    description: 'Активно контролював і санкціонував застосування репресивних заходів, використовуючи їх як засіб усунення опонентів та консолідації влади.',
    link: '/figures'
  },
  {
    title: 'Микита Хрущов',
    description: 'Після Сталіна продовжував репресії, але пізніше ініціював розкриття їх масштабів та реформи.',
    link: '/figures'
  },
  {
    title: 'НКВД',
  ...
  {
    title: 'Галерея',
    description: 'Фотографії, документи та артефакти періоду репресій.',
    link: '/gallery'
  }
])
