...
const keyPoints = ref([
  {
    title: 'Хронологія',
    description: 'Детальний опис подій та їх послідовність',
    link: '/timeline',
    icon: '📅'
  },
  {
    title: 'Ключові постаті',
    description: 'Біографії та діяльність основних учасників',
    link: '/artists',
    icon: '👥'
  },
  {
    title: 'Реферат',
    description: 'Детальний аналіз масових репресій в Україні',
    link: '/referat',
    icon: '📚'
  }
])
